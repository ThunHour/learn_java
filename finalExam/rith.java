...
public class rith {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection conn = DriverManager
                .getConnection("jdbc:mysql:Server=\"192.168.0.107\";User=\"root\";Password=\"root\";");
        ...
        stmt2.setInt(1, 1);
        stmt2.setString(2, "Apache");
        stmt2.setInt(3, 12000);
        stmt2.setString(4, "2011-02-21");
        stmt2.executeUpdate();

        stmt2.setInt(1, 2);
        stmt2.setString(2, "Firebase");
        stmt2.setInt(3, 52000);
        stmt2.setString(4, "2010-12-01");
        stmt2.executeUpdate();

        stmt2.setInt(1, 3);
        stmt2.setString(2, "Nginx ");
        stmt2.setInt(3, 2000);
        stmt2.setString(4, "2002-02-15");
        stmt2.executeUpdate();

        stmt2.setInt(1, 4);
        stmt2.setString(2, "LiteSpeed");
        stmt2.setInt(3, 111000);
        stmt2.setString(4, "2018-11-28");
        stmt2.executeUpdate();

        stmt2.setInt(1, 5);
        stmt2.setString(2, "IIS");
        stmt2.setInt(3, 51000);
        stmt2.setString(4, "2019-02-17");
        stmt2.executeUpdate();
